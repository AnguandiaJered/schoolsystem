                  ...
                  <v-form ref="form" lazy-validation>
                      ...
                      <v-card-text max-height="1500px" background-color: white>
                          <v-row>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Code Ecole" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <template v-slot:default>
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-left">Adresse physique</th>
                                          <th class="text-left">Adresse maiel</th>
                                          <th class="text-left">Contact</th>
                                          <th class="text-left">Code Ecole</th>
  ...
  methods: {
      ...
      testTitle() {
          if (this.edit == true) {
              ...
              this.titleComponent = "Paramètrage du Enseignant ";
              this.style.height = "0px";
          }
      },
