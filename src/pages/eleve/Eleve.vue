                  ...
                  <v-form ref="form" lazy-validation>
                      ...
                      <v-card-text max-height="1500px" background-color: white>
                          <v-row>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Nom" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Postnom" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Prénom" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                <div class="mr-1">
                                  <v-select label="Sexe" :items="[
                                    ...
                                    item-title="designation" item-value="designation"></v-select>
                                </div>
                              </v-col>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Synthese Adresse Complète" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Nationalité" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Nom de Tutaire" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Profession du Tutaire" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="N° de Téléphone Tutaire" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6" class="mb-2">
                              ...
                              <template v-slot:default>
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-left">Date Naissance</th>
                                          <th class="text-left">Lieu de Naissance</th>
                                          <th class="text-left">Adresse Complète</th>
                                          <th class="text-left">Nationalité</th>
                                          <th class="text-left">Tutaire</th>
                                              ...
                                              <v-menu bottom rounded offset-y transition="scale-transition">
                                                  ...
                                                  <v-list dense width="">
                                                      ...
                                                      <v-list-item link>
                                                          ...
                                                          <v-list-item-title style="margin-left: -20px">Affectation de l'Enseignant</v-list-item-title>
                                                      </v-list-item>
...
export default {
  ...
  methods: {
      ...
      showModal() {
          this.dialog = true;
          this.titleComponent = "Enregistrement Elève";
          this.edit = false;
      ...
      testTitle() {
          if (this.edit == true) {
              this.titleComponent = "Modification Elève";
              this.style.height = "0px";
          } else {
              this.titleComponent = "Paramètrage d'Elève ";
              this.style.height = "0px";
          }
      },
