                      ...
                      <v-card-text max-height="500px" background-color: white>
                          <v-flex row wrap>
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                <div class="mr-1">
                                  <v-select label="Selectionnez l'enseignant" :items="[
                                    { designation: 'Homme' },
                                    { designation: 'Femme' }
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                <div class="mr-1">
                                  <v-select label="Selectionnez la Classe" :items="[
                                    { designation: 'Homme' },
                                    { designation: 'Femme' }
                                  ]" prepend-inner-icon="extension" :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                                    item-title="designation" item-value="designation"></v-select>
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                <div class="mr-1">
                                  <v-select label="Selectionnez l'Année" :items="[
                                    { designation: 'Homme' },
                                    { designation: 'Femme' }
                                  ]" prepend-inner-icon="extension" :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                                    item-title="designation" item-value="designation"></v-select>
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                  <div class="mr-1">
                                      <v-text-field type="date" label="Date Affectation" prepend-inner-icon="event"
                              ...
                              <template v-slot:default>
                                  <thead>
                                      <tr>
                                          ...
                                          <th class="text-left">Date Affectation</th>
                                          <th>Mise à jour</th>
...
export default {
  ...
  methods: {
      ...
      showModal() {
          this.dialog = true;
          this.titleComponent = "Enregistrement Inscription";
          this.edit = false;
      ...
      testTitle() {
          if (this.edit == true) {
              this.titleComponent = "Modification Inscription";
              this.style.height = "0px";
          } else {
              this.titleComponent = "Paramètrage d'Inscription ";
              this.style.height = "0px";
          }
      },
