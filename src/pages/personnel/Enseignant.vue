                  ...
                  <v-form ref="form" lazy-validation>
                      ...
                      <v-card-text max-height="1500px" background-color: white>
                          <v-row>
                              ...
                              <v-col cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Institution (Ecole)" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
...
export default {
  ...
  methods: {
      ...
      showModal() {
          this.dialog = true;
          this.titleComponent = "Enregistrement Enseignant";
          this.edit = false;
      ...
      testTitle() {
          if (this.edit == true) {
              this.titleComponent = "Modification Enseignant";
              this.style.height = "0px";
          } else {
              this.titleComponent = "Paramètrage de l'Enseignant ";
              this.style.height = "0px";
          }
      },
