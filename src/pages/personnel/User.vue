                  ...
                  <v-form ref="form" lazy-validation>
                      ...
                      <v-card-text max-height="1500px" background-color: white>
                          <v-flex>
                              ...
                              <v-flex cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Mot de passe" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-flex cols="12" md="6" xs="12" sm="12" lg="6">
                                  <div class="mr-1">
                                      <v-text-field label="Phone number" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-flex cols="12" md="6" xs="12" sm="12" lg="6" class="mb-2">
                                              ...
                                              <v-menu bottom rounded offset-y transition="scale-transition">
                                                  ...
                                                  <v-list dense width="">
                                                      ...
                                                      <v-list-item link>
                                                          ...
                                                          <v-list-item-title style="margin-left: -20px">Role</v-list-item-title>
                                                      </v-list-item>
                                                      ...
                                                      <v-list-item link>
                                                          ...
                                                          <v-list-item-title style="margin-left: -20px">Permission</v-list-item-title>
                                                      </v-list-item>
...
export default {
  ...
  methods: {
      ...
      showModal() {
          this.dialog = true;
          this.titleComponent = "Enregistrement Utilisateur";
          this.edit = false;
      ...
      testTitle() {
          if (this.edit == true) {
              this.titleComponent = "Modification Utilisateur";
              this.style.height = "0px";
          } else {
              this.titleComponent = "Paramètrage d'Utilisateur ";
              this.style.height = "0px";
          }
      },
