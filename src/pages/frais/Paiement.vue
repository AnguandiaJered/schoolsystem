                      ...
                      <v-card-text max-height="500px" background-color: white>
                          <v-flex>
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                  <div class="mr-1">
                                      <v-text-field label="Montant" prepend-inner-icon="draw" dense
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                  <div class="mr-1">
                                      <v-text-field label="Libelle" prepend-inner-icon="draw" dense
                                          :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                          >
                                      </v-text-field>
                                  </div>
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                  <div class="mr-1">
                                      <v-text-field type="date" label="Date Paiement" prepend-inner-icon="event"
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                <div class="mr-1">
                                  <v-select label="Selectionnez l'elève" :items="[
                                    { designation: 'Homme' },
                                    { designation: 'Femme' }
                              ...
                              <v-flex xs12 sm12 md6 lg6>
                                <div class="mr-1">
                                  <v-select label="Selectionnez le frais" :items="[
                                    { designation: 'Homme' },
                                    { designation: 'Femme' }
                                  ]" prepend-inner-icon="extension" :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                                    item-title="designation" item-value="designation"></v-select>
                      ...
                      <v-card-text>
                          <v-table class="elevation-1">
                              <template v-slot:default>
                                  <thead>
                                      <tr>
                                          <th class="text-left">Montant Payer</th>
                                          <th class="text-left">Libelle</th>
                                          <th class="text-left">Reste</th>
                                          <th class="text-left">Date Paiement</th>
...
export default {
  ...
  methods: {
      ...
      showModal() {
          this.dialog = true;
          this.titleComponent = "Enregistrement Paiement";
          this.edit = false;
      ...
      testTitle() {
          if (this.edit == true) {
              this.titleComponent = "Modification Paiement";
              this.style.height = "0px";
          } else {
              this.titleComponent = "Paramètrage du Paiement ";
              this.style.height = "0px";
          }
      },
